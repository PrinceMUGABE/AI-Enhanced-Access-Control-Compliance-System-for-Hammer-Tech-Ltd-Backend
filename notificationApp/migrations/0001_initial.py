...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('chatApp', '0002_callparticipant_videocall_callparticipant_call_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('new_message', 'New Message'), ('case_assigned', 'Case Assigned'), ('case_status_changed', 'Case Status Changed'), ('chat_created', 'Chat Created'), ('participant_added', 'Participant Added'), ('participant_removed', 'Participant Removed'), ('chat_archived', 'Chat Archived'), ('session_scheduled', 'Session Scheduled'), ('session_completed', 'Session Completed'), ('session_cancelled', 'Session Cancelled'), ('session_rescheduled', 'Session Rescheduled'), ('session_reminder', 'Session Reminder'), ('program_completed', 'Program Completed'), ('mentorship_completed', 'Mentorship Completed')], max_length=50)),
                ('title', models.CharField(max_length=200)),
                ('message', models.TextField()),
                ...
                ('chat_room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='notifications', to='chatApp.chatroom')),
                ('mentorship', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='notifications', to='mentorshipApp.mentorship')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['recipient', 'is_read'], name='notificatio_recipie_0b4a26_idx'), models.Index(fields=['created_at'], name='notificatio_created_87c9ef_idx'), models.Index(fields=['notification_type'], name='notificatio_notific_b2cb93_idx'), models.Index(fields=['is_archived'], name='notificatio_is_arch_9c12b6_idx')],
            },
        ),
        migrations.CreateModel(
